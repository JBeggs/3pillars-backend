...
# Register additional CRM models to crm_site
crm_site.register(ClientType, ClientTypeAdmin)
crm_site.register(Country, CountryAdmin)
crm_site.register(Industry, IndustryAdmin)
crm_site.register(LeadSource, LeadSourceAdmin)
crm_site.register(ProductCategory, ProductCategoryAdmin)
crm_site.register(ClosingReason, ClosingReasonAdmin)
crm_site.register(Stage, StageAdmin)
crm_site.register(Rate, RateAdmin)
